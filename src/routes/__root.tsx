...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Muhammad Usman — WordPress Developer Portfolio" },
      {
        name: "description",
        content:
          "Freelance WordPress developer: custom themes, plugins, WooCommerce, security hardening and speed optimization.",
      },
      { name: "author", content: "Muhammad Usman" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Muhammad Usman — WordPress Developer" },
